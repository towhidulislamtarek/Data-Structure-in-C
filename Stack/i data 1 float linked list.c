...
struct Node *createNode(int int_data, float float_data)
{
...
void push(int int_data, float float_data)
{
    struct Node *newNode = createNode(int_data, float_data);
    newNode->next = top;
    top = newNode;
}
